...
import svgHover from "./mapPointHover.svg";
...
function Map({ isSticky }) {
	...
	let getFacilityList = async () => {
		let result = await axios.get(
			"https://isl-enigma-server.vercel.app/map/mapPage"
		);
	...
	function handleType(typeArr) {
		typeArr.current.forEach((elem) => {
			...
			// elem.style.backgroundImage ="url('data:image/svg+xml,%3csvg%20width='48'%20height='68'%20viewBox='0%200%2048%2068'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20filter='url(%23filter0_bdi_1242_6205)'%3e%3ccircle%20cx='24'%20cy='20'%20r='20'%20fill='%23B56C8A'/%3e%3cpath%20d='M24%2060L6.67949%2030L41.3205%2030L24%2060Z'%20fill='%23B56C8A'/%3e%3c/g%3e%3cdefs%3e%3cfilter%20id='filter0_bdi_1242_6205'%20x='-3.7'%20y='-7.7'%20width='55.4'%20height='75.7'%20filterUnits='userSpaceOnUse'%20color-interpolation-filters='sRGB'%3e%3cfeFlood%20flood-opacity='0'%20result='BackgroundImageFix'/%3e%3cfeGaussianBlur%20in='BackgroundImageFix'%20stdDeviation='3.85'/%3e%3cfeComposite%20in2='SourceAlpha'%20operator='in'%20result='effect1_backgroundBlur_1242_6205'/%3e%3cfeColorMatrix%20in='SourceAlpha'%20type='matrix'%20values='0%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%20127%200'%20result='hardAlpha'/%3e%3cfeOffset%20dy='4'/%3e%3cfeGaussianBlur%20stdDeviation='2'/%3e%3cfeComposite%20in2='hardAlpha'%20operator='out'/%3e%3cfeColorMatrix%20type='matrix'%20values='0%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200.25%200'/%3e%3cfeBlend%20mode='normal'%20in2='effect1_backgroundBlur_1242_6205'%20result='effect2_dropShadow_1242_6205'/%3e%3cfeBlend%20mode='normal'%20in='SourceGraphic'%20in2='effect2_dropShadow_1242_6205'%20result='shape'/%3e%3cfeColorMatrix%20in='SourceAlpha'%20type='matrix'%20values='0%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%200%20127%200'%20result='hardAlpha'/%3e%3cfeOffset%20dy='4'/%3e%3cfeGaussianBlur%20stdDeviation='2'/%3e%3cfeComposite%20in2='hardAlpha'%20operator='arithmetic'%20k2='-1'%20k3='1'/%3e%3cfeColorMatrix%20type='matrix'%20values='0%200%200%200%201%200%200%200%200%201%200%200%200%200%201%200%200%200%200.52%200'/%3e%3cfeBlend%20mode='normal'%20in2='shape'%20result='effect3_innerShadow_1242_6205'/%3e%3c/filter%3e%3c/defs%3e%3c/svg%3e')";
