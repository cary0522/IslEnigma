...
function Map() {
	...
	const facilityList = [
		...
		},
		{
			...
			des: "透明的海底隧道，讓遊客可以步行穿過，近距離觀賞海洋生物和水下景觀。",
			content:
				"隨著引導指標緩步下行，進入81公尺長之壓克力隧道，穿梭於海洋之中，帶您親自體驗絢爛多采、生氣盎然的海底世界。另有常設稀有深海生物展，詳細場次請至「迷樣快報」查詢。",
			image: "",
			location:'璀璨綠洲',
			open_time:'9:00~17:30',
			data_maintain:'2024/3/7 下午',
		...
		},
		{
			...
			content:
				"目前國內最長的人工泛舟河道，水道全長七百五十公尺，每艘圓型橡膠船可乘坐二至九人，全程約十分鐘。沿途可以欣賞失落小島獨特的風景，途中有激流、奇岩怪石，每個彎曲處，都可能是冒險旅程的開端，充滿著驚喜與趣味，還有隨時會被水砲攻擊的驚險時刻。",
			image: "",
			location:'璀璨綠洲',
			open_time:'9:00~17:30',
			data_maintain:'2024/3/7 下午',
		...
		},
		{
			...
			des: "高空旋轉塔，真實體驗飛翔的感覺。",
			content:
				"搭乘著座椅緩緩上升時，您在忐忑不安的心情中可以欣賞迷樣島嶼全貌並鳥瞰失落小島獨特的風景。上升至最高點時，你將真實感受到飛翔的體驗，彷彿置身於高空中，就在此時，座椅將以自由落體的G速度向下墬落，就在您尖叫「啊！」的一聲尚未結束的幾秒中，剎那間已從五十三公尺(十七層樓高)降至地面，在頭皮發麻下體驗地心引力的威力！",
			image: "",
			location:'璀璨綠洲',
			open_time:'9:00~17:30',
			data_maintain:'2024/3/7 下午',
		...
		},
		{
			...
			content:
				"透明景觀冷氣車廂，讓你輕鬆舒適眺望失落小鎮美景，到制高點時，可以將整座迷樣島嶼一覽無遺，每座車廂可容納8人，搭乘一圈約為18分鐘，夜間128種炫麗燈光秀，在義大摩天輪上，將美麗景致盡收眼底。",
			image: "",
			location:'璀璨綠洲',
			open_time:'9:00~17:30',
			data_maintain:'2024/3/7 下午',
