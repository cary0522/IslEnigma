$(document).ready(function () {
    const cardData = [
        ...
        },
        {
            ...
            link: '#',
            details: '園區設有多家主題紀念品商店，提供獨特的islEnigma限定商品。部分商品提供客製化服務，如刻字或印製照片。某些特殊體驗還提供專屬紀念品，建議在體驗後選購。<a class="btn button">查看餐廳</a>'
        },
        {
    ...
    function displayCards(page) {
        ...
        pageItems.forEach((item, index) => {
            ...
            card.className = 'col';
            card.innerHTML = `
                    <div class="card" data-bs-toggle="modal" data-bs-target="#detailModal" data-index="${startIndex + index}">
                        ...
                        <div class="cardContent">
                            ...
                            <p class="cardText">${item.content}</p>
                            <a href="${item.link}" class="btnLink">了解更多</a>
                        </div>
                    </div>
                `;
    ...
    function setupModalListeners() {
        ...
        modal.addEventListener('show.bs.modal', function (event) {
            ...
            const cardIndex = button.closest('.card').dataset.index;
            ...
            modalBody.innerHTML = `<p>${item.details}</p>`;
        });
    }
