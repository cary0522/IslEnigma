export const rooms = [
    {
        ...
        images: ['../../public/roomMorePage/room (26).png', '../../public/roomMorePage/room (12).jpeg', '../../public/roomMorePage/room (32).png', "../../public/roomMorePage/room (2).jpg"]
    },
    {
        ...
        images: ['../../public/roomMorePage/room (13).jpg', '../../public/roomMorePage/room (10).jpeg', '../../public/roomMorePage/room (24).jpeg', '../../public/roomMorePage/room (64).png']
    },
    {
        ...
        images: ['../../public/roomMorePage/room (7).png', '../../public/roomMorePage/room (15).jpeg', '../../public/roomMorePage/room (23).jpeg', '../../public/roomMorePage/room (59).png']
    },
    {
        ...
        images: ['../../public/roomMorePage/room (1).jpeg', '../../public/roomMorePage/room (47).png', '../../public/roomMorePage/room (29).png', '../../public/roomMorePage/room (8).jpg']
    }
];

export const facilities = [
    { icon: "tv", text: "32吋 LED電視" },
    { icon: "tv", text: "MOD電視頻道" },
    { icon: "temperature-low", text: "可調式中央空調" },
    { icon: "plug", text: "多種電源座" },
    { icon: "music", text: "藍芽立體聲音響系統" },
    { icon: "volume-mute", text: "智慧靜音系統" },
    { icon: "lightbulb", text: "床頭閱讀燈" },
