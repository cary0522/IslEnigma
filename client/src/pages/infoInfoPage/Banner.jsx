...
const Banner = () => {
    ...
    const dropdownOptions = [
        ...
        { text: '樂園須知', href: '../info_info.html', value: 'parkInfo' },
        { text: '常見問題', href: '#', value: 'frequentlyAskedQuestions' },
        { text: '今日活動', href: '#todayActivities', value: 'timeTable' },
        { text: '遊園建議', href: '#', value: 'parkSuggestions' }
    ];
                ...
                <div className="bannerMenu">
                    ...
                    <div className="bannerItemGroup">
                        ...
                        <a href="#" className="menuItem">
                            ...
                            <div className="menuIcon">
                                <img src="../../public/00myIcon/park-info2.png" alt="樂園須知圖示" />
                            </div>
                            <p>樂園須知</p>
                        </a>
                        <a href="#" className="menuItem">
                        ...
                        <a href="#" className="menuItem">
                            ...
                            <div className="menuIcon">
                                <img src="../../public/00myIcon/advice.png" alt="遊園建議圖示" />
                            </div>
                            <p>遊園建議</p>
                        </a>
                    </div>
